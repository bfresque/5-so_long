...
{
	if((keycode == W || keycode == UP) && data->tab[data->player_y - 1][data->player_x] != '1')
		move_up(data);
	if((keycode == S || keycode == DOWN) && data->tab[data->player_y + 1][data->player_x] != '1')
		move_down(data);
	if((keycode == D || keycode == RIGHT) && data->tab[data->player_y][data->player_x + 1] != '1')
		move_right(data);
	if((keycode == A || keycode == LEFT) && data->tab[data->player_y][data->player_x - 1] != '1')
		move_left(data);
